...
def dataloader(filepath, typ = 'train'):
  ...
  right_fold = 'image_3/'
  disp_L = 'disp_occ_0/'
  sem_L = 'NVIDIA_semantic/semantic_2/'
  sem_R = 'NVIDIA_semantic/semantic_3/'  
  inst_L = '/PointRend/instance_2/'
  inst_R = '/PointRend/instance_3/'
  ...
  return left_train, right_train, disp_train_L, sem_train_L, sem_train_R, inst_train_L, inst_train_R, left_val, right_val, disp_val_L